...
public class DaikinPackage {
    ...
    private static final String LIRC_FRAME_START = DaikinDecoder.IR_FRAME_SEPARATOR_PULSE + DaikinDecoder.LIRC_SPACE + DaikinDecoder.IR_FRAME_SEPARATOR_SPACE + DaikinDecoder.LIRC_SPACE;
    private static final String LIRC_PACKAGE_START = DaikinDecoder.IR_SEPARATOR_PULSE + DaikinDecoder.LIRC_SPACE + DaikinDecoder.IR_PACKAGE_START + DaikinDecoder.LIRC_SPACE;
    private static final String LIRC_MIDDLE_PACKAGE_START = DaikinDecoder.IR_SEPARATOR_PULSE + DaikinDecoder.LIRC_SPACE + DaikinDecoder.IR_FRAME_START + DaikinDecoder.LIRC_SPACE;
    private static final String LIRC_ZERO = DaikinDecoder.IR_SEPARATOR_PULSE + DaikinDecoder.LIRC_SPACE + DaikinDecoder.IR_ZERO + DaikinDecoder.LIRC_SPACE;
    private static final String LIRC_ONE = DaikinDecoder.IR_SEPARATOR_PULSE + DaikinDecoder.LIRC_SPACE + DaikinDecoder.IR_ONE + DaikinDecoder.LIRC_SPACE;

    private int[] frameOneStatic = new int[]{0x11, 0xDA, 0x27, 0x00, 0xC5, 0x30, 0x00, 0x07};
    private int[] frameTwoStatic = new int[]{0x11, 0xDA, 0x27, 0x00, 0x42, 0x00, 0x08, 0x5C};
    ...
    private static String getBin(int minutesFromMidnight) {
